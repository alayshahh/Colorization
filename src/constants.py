...
GREY_NORMALIZED = np.load('./assets/improved_agent/greyscale_normal.npy')
RGB_NORMALIZED = np.load('./assets/improved_agent/rgb_normal.npy')
IMPROVED_OUT = np.load('./assets/improved_agent/out_matrix.npy')
