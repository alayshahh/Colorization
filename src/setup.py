...
if __name__ == '__main__':
    ...
    enlarged_rgb = enlarge_rgb_for_report(
        np.load('./assets/basic_agent_values.npy'), 25)
    enlarged_rgb.save('./assets/report/enlarged_basic_agent.png')
